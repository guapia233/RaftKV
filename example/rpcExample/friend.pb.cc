...
extern PROTOBUF_INTERNAL_EXPORT_friend_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0>
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendsListRequest_friend_2eproto = {
    {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0,
     InitDefaultsscc_info_GetFriendsListRequest_friend_2eproto},
    {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendsListResponse_friend_2eproto = {
    {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0,
     InitDefaultsscc_info_GetFriendsListResponse_friend_2eproto},
    {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode_friend_2eproto = {
    {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0,
     InitDefaultsscc_info_ResultCode_friend_2eproto},
    {}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
static bool dynamic_init_dummy_friend_2eproto =
    (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_friend_2eproto)), true);
namespace fixbug {
...
ResultCode::ResultCode(::PROTOBUF_NAMESPACE_ID::Arena* arena) : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
    SharedCtor();
    RegisterArenaDtor(arena);
    // @@protoc_insertion_point(arena_constructor:fixbug.ResultCode)
}
ResultCode::ResultCode(const ResultCode& from) : ::PROTOBUF_NAMESPACE_ID::Message() {
...
::PROTOBUF_NAMESPACE_ID::uint8* ResultCode::_InternalSerialize(
    ...
    if (this->errcode() != 0) {
        ...
        target =
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->_internal_errcode(), target);
    }

    // bytes errmsg = 2;
    if (this->errmsg().size() > 0) {
        target = stream->WriteBytesMaybeAliased(2, this->_internal_errmsg(), target);
    }
...
size_t ResultCode::ByteSizeLong() const {
    ...
    // bytes errmsg = 2;
    if (this->errmsg().size() > 0) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(this->_internal_errmsg());
    }

    // int32 errcode = 1;
    if (this->errcode() != 0) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(this->_internal_errcode());
    }
...
void ResultCode::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
    ...
    const ResultCode* source = ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ResultCode>(&from);
    if (source == nullptr) {
...
::PROTOBUF_NAMESPACE_ID::Metadata ResultCode::GetMetadata() const { return GetMetadataStatic(); }
...
GetFriendsListRequest::GetFriendsListRequest(const GetFriendsListRequest& from) : ::PROTOBUF_NAMESPACE_ID::Message() {
    _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void GetFriendsListRequest::SharedDtor() { GOOGLE_DCHECK(GetArena() == nullptr); }
...
void GetFriendsListRequest::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* GetFriendsListRequest::_InternalParse(const char* ptr,
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendsListRequest::_InternalSerialize(
    ...
    if (this->userid() != 0) {
        target = stream->EnsureSpace(target);
        target =
            ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->_internal_userid(), target);
    }
...
size_t GetFriendsListRequest::ByteSizeLong() const {
    ...
    // uint32 userid = 1;
    if (this->userid() != 0) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::UInt32Size(this->_internal_userid());
    }
...
void GetFriendsListRequest::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
    ...
    GOOGLE_DCHECK_NE(&from, this);
    const GetFriendsListRequest* source = ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendsListRequest>(&from);
    if (source == nullptr) {
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendsListRequest::GetMetadata() const { return GetMetadataStatic(); }

// ===================================================================

void GetFriendsListResponse::InitAsDefaultInstance() {
    ::fixbug::_GetFriendsListResponse_default_instance_._instance.get_mutable()->result_ =
        const_cast<::fixbug::ResultCode*>(::fixbug::ResultCode::internal_default_instance());
}
...
GetFriendsListResponse::GetFriendsListResponse(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), friends_(arena) {
    SharedCtor();
    RegisterArenaDtor(arena);
...
GetFriendsListResponse::GetFriendsListResponse(const GetFriendsListResponse& from)
    : ::PROTOBUF_NAMESPACE_ID::Message(), friends_(from.friends_) {
    _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
...
void GetFriendsListResponse::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
const char* GetFriendsListResponse::_InternalParse(const char* ptr,
                                                   ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) \
    if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
    ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena();
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendsListResponse::_InternalSerialize(
    ...
    if (this->has_result()) {
        target = stream->EnsureSpace(target);
        target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(1, _Internal::result(this),
                                                                                         target, stream);
    }
...
size_t GetFriendsListResponse::ByteSizeLong() const {
    ...
    // repeated bytes friends = 2;
    total_size += 1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(friends_.size());
    for (int i = 0, n = friends_.size(); i < n; i++) {
        total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(friends_.Get(i));
    }

    // .fixbug.ResultCode result = 1;
    if (this->has_result()) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(*result_);
    }
...
void GetFriendsListResponse::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
    ...
    const GetFriendsListResponse* source =
        ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetFriendsListResponse>(&from);
    if (source == nullptr) {
...
::PROTOBUF_NAMESPACE_ID::Metadata GetFriendsListResponse::GetMetadata() const { return GetMetadataStatic(); }
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* FiendServiceRpc::GetDescriptor() { return descriptor(); }
...
template <>
PROTOBUF_NOINLINE ::fixbug::ResultCode* Arena::CreateMaybeMessage<::fixbug::ResultCode>(Arena* arena) {
    return Arena::CreateMessageInternal<::fixbug::ResultCode>(arena);
}
template <>
PROTOBUF_NOINLINE ::fixbug::GetFriendsListRequest* Arena::CreateMaybeMessage<::fixbug::GetFriendsListRequest>(
    Arena* arena) {
    return Arena::CreateMessageInternal<::fixbug::GetFriendsListRequest>(arena);
}
template <>
PROTOBUF_NOINLINE ::fixbug::GetFriendsListResponse* Arena::CreateMaybeMessage<::fixbug::GetFriendsListResponse>(
    Arena* arena) {
