...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetArgs_kvServerRPC_2eproto = {
    {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0,
     InitDefaultsscc_info_GetArgs_kvServerRPC_2eproto},
    {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetReply_kvServerRPC_2eproto = {
    {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0,
     InitDefaultsscc_info_GetReply_kvServerRPC_2eproto},
    {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PutAppendArgs_kvServerRPC_2eproto = {
    {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0,
     InitDefaultsscc_info_PutAppendArgs_kvServerRPC_2eproto},
    {}};
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_PutAppendReply_kvServerRPC_2eproto = {
    {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0,
     InitDefaultsscc_info_PutAppendReply_kvServerRPC_2eproto},
    {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_kvServerRPC_2eproto[4];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_kvServerRPC_2eproto =
    nullptr;
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_kvServerRPC_2eproto[1];

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_kvServerRPC_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kvServerRPC_2eproto = {
    ...
    descriptor_table_kvServerRPC_2eproto_sccs,
    descriptor_table_kvServerRPC_2eproto_deps,
    4,
    0,
    schemas,
...
static bool dynamic_init_dummy_kvServerRPC_2eproto =
    (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_kvServerRPC_2eproto)), true);
namespace raftKVRpcProctoc {
...
GetArgs::GetArgs(::PROTOBUF_NAMESPACE_ID::Arena* arena) : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
    SharedCtor();
    RegisterArenaDtor(arena);
    // @@protoc_insertion_point(arena_constructor:raftKVRpcProctoc.GetArgs)
}
GetArgs::GetArgs(const GetArgs& from) : ::PROTOBUF_NAMESPACE_ID::Message() {
    _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
    key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    if (!from._internal_key().empty()) {
        key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_key(), GetArena());
    }
...
void GetArgs::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
::PROTOBUF_NAMESPACE_ID::uint8* GetArgs::_InternalSerialize(
    ...
    if (this->clientid().size() > 0) {
        target = stream->WriteBytesMaybeAliased(2, this->_internal_clientid(), target);
    }

    // int32 RequestId = 3;
    if (this->requestid() != 0) {
        target = stream->EnsureSpace(target);
        target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(3, this->_internal_requestid(),
                                                                                      target);
    }
...
size_t GetArgs::ByteSizeLong() const {
    ...
    // bytes ClientId = 2;
    if (this->clientid().size() > 0) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(this->_internal_clientid());
    }

    // int32 RequestId = 3;
    if (this->requestid() != 0) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::Int32Size(this->_internal_requestid());
    }
...
void GetArgs::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
    ...
    const GetArgs* source = ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetArgs>(&from);
    if (source == nullptr) {
...
bool GetArgs::IsInitialized() const { return true; }
...
::PROTOBUF_NAMESPACE_ID::Metadata GetArgs::GetMetadata() const { return GetMetadataStatic(); }
...
GetReply::GetReply(::PROTOBUF_NAMESPACE_ID::Arena* arena) : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
    SharedCtor();
    RegisterArenaDtor(arena);
    // @@protoc_insertion_point(arena_constructor:raftKVRpcProctoc.GetReply)
}
GetReply::GetReply(const GetReply& from) : ::PROTOBUF_NAMESPACE_ID::Message() {
    _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
    err_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    if (!from._internal_err().empty()) {
        err_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_err(), GetArena());
    }
...
void GetReply::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
::PROTOBUF_NAMESPACE_ID::uint8* GetReply::_InternalSerialize(
    ...
    // bytes Err = 1;
    if (this->err().size() > 0) {
        target = stream->WriteBytesMaybeAliased(1, this->_internal_err(), target);
    }
...
size_t GetReply::ByteSizeLong() const {
    ...
    // bytes Err = 1;
    if (this->err().size() > 0) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(this->_internal_err());
    }
...
void GetReply::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
    ...
    GOOGLE_DCHECK_NE(&from, this);
    const GetReply* source = ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<GetReply>(&from);
    if (source == nullptr) {
...
bool GetReply::IsInitialized() const { return true; }
...
::PROTOBUF_NAMESPACE_ID::Metadata GetReply::GetMetadata() const { return GetMetadataStatic(); }
...
PutAppendArgs::PutAppendArgs(::PROTOBUF_NAMESPACE_ID::Arena* arena) : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
    SharedCtor();
    RegisterArenaDtor(arena);
    // @@protoc_insertion_point(arena_constructor:raftKVRpcProctoc.PutAppendArgs)
}
PutAppendArgs::PutAppendArgs(const PutAppendArgs& from) : ::PROTOBUF_NAMESPACE_ID::Message() {
    _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
    key_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    if (!from._internal_key().empty()) {
        key_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_key(), GetArena());
    ...
    if (!from._internal_op().empty()) {
        op_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_op(), GetArena());
    }
    clientid_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    if (!from._internal_clientid().empty()) {
        clientid_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_clientid(),
...
void PutAppendArgs::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
::PROTOBUF_NAMESPACE_ID::uint8* PutAppendArgs::_InternalSerialize(
    ...
    // bytes Op = 3;
    if (this->op().size() > 0) {
        target = stream->WriteBytesMaybeAliased(3, this->_internal_op(), target);
    }

    // bytes ClientId = 4;
    if (this->clientid().size() > 0) {
        target = stream->WriteBytesMaybeAliased(4, this->_internal_clientid(), target);
    }

    // int32 RequestId = 5;
    if (this->requestid() != 0) {
        target = stream->EnsureSpace(target);
        target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(5, this->_internal_requestid(),
                                                                                      target);
    }
...
size_t PutAppendArgs::ByteSizeLong() const {
    ...
    // bytes Op = 3;
    if (this->op().size() > 0) {
        total_size += 1 + ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(this->_internal_op());
    }
...
void PutAppendArgs::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
    ...
    GOOGLE_DCHECK_NE(&from, this);
    const PutAppendArgs* source = ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PutAppendArgs>(&from);
    if (source == nullptr) {
...
bool PutAppendArgs::IsInitialized() const { return true; }
...
::PROTOBUF_NAMESPACE_ID::Metadata PutAppendArgs::GetMetadata() const { return GetMetadataStatic(); }
...
PutAppendReply::PutAppendReply(::PROTOBUF_NAMESPACE_ID::Arena* arena) : ::PROTOBUF_NAMESPACE_ID::Message(arena) {
    SharedCtor();
    RegisterArenaDtor(arena);
    // @@protoc_insertion_point(arena_constructor:raftKVRpcProctoc.PutAppendReply)
}
PutAppendReply::PutAppendReply(const PutAppendReply& from) : ::PROTOBUF_NAMESPACE_ID::Message() {
    _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
    err_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    if (!from._internal_err().empty()) {
        err_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_err(), GetArena());
...
void PutAppendReply::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
void PutAppendReply::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
    ...
    GOOGLE_DCHECK_NE(&from, this);
    const PutAppendReply* source = ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<PutAppendReply>(&from);
    if (source == nullptr) {
...
bool PutAppendReply::IsInitialized() const { return true; }
...
::PROTOBUF_NAMESPACE_ID::Metadata PutAppendReply::GetMetadata() const { return GetMetadataStatic(); }
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* kvServerRpc::GetDescriptor() { return descriptor(); }

void kvServerRpc::PutAppend(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                            const ::raftKVRpcProctoc::PutAppendArgs*, ::raftKVRpcProctoc::PutAppendReply*,
                            ::google::protobuf::Closure* done) {
    controller->SetFailed("Method PutAppend() not implemented.");
    done->Run();
}

void kvServerRpc::Get(::PROTOBUF_NAMESPACE_ID::RpcController* controller, const ::raftKVRpcProctoc::GetArgs*,
                      ::raftKVRpcProctoc::GetReply*, ::google::protobuf::Closure* done) {
    ...
    switch (method->index()) {
        case 0:
            PutAppend(controller,
                      ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::raftKVRpcProctoc::PutAppendArgs*>(request),
                      ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::raftKVRpcProctoc::PutAppendReply*>(response), done);
            break;
        case 1:
            Get(controller, ::PROTOBUF_NAMESPACE_ID::internal::DownCast<const ::raftKVRpcProctoc::GetArgs*>(request),
                ::PROTOBUF_NAMESPACE_ID::internal::DownCast<::raftKVRpcProctoc::GetReply*>(response), done);
            break;
        default:
...
template <>
PROTOBUF_NOINLINE ::raftKVRpcProctoc::GetArgs* Arena::CreateMaybeMessage<::raftKVRpcProctoc::GetArgs>(Arena* arena) {
    return Arena::CreateMessageInternal<::raftKVRpcProctoc::GetArgs>(arena);
}
template <>
PROTOBUF_NOINLINE ::raftKVRpcProctoc::GetReply* Arena::CreateMaybeMessage<::raftKVRpcProctoc::GetReply>(Arena* arena) {
    return Arena::CreateMessageInternal<::raftKVRpcProctoc::GetReply>(arena);
}
template <>
PROTOBUF_NOINLINE ::raftKVRpcProctoc::PutAppendArgs* Arena::CreateMaybeMessage<::raftKVRpcProctoc::PutAppendArgs>(
    Arena* arena) {
    return Arena::CreateMessageInternal<::raftKVRpcProctoc::PutAppendArgs>(arena);
}
template <>
PROTOBUF_NOINLINE ::raftKVRpcProctoc::PutAppendReply* Arena::CreateMaybeMessage<::raftKVRpcProctoc::PutAppendReply>(
    Arena* arena) {
